local speed = 50
if not isfile("dango.rbxm") then
    writefile("dango.rbxm", game:HttpGet("https://github.com/Volta07/stuff/raw/main/dango.rbxm"))
end
local rush = game:GetObjects((getcustomasset or getsynasset)("dango.rbxm"))[1]
