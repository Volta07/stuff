local speed = 50
if not isfile("Crep.rbxm") then
    writefile("Crep.rbxm", game:HttpGet("https://github.com/Volta07/stuff/raw/main/Crep.rbxm"))
end
local rush = game:GetObjects((getcustomasset or getsynasset)("Crep.rbxm"))[1]
