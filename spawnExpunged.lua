local speed = 50
if not isfile("expunged.rbxm") then
    writefile("expunged.rbxm", game:HttpGet("https://github.com/Volta07/stuff/raw/main/expunged.rbxm"))
end
local rush = game:GetObjects((getcustomasset or getsynasset)("expunged.rbxm"))[1]
...
local function setRooms()
	...
	table.foreach(workspace.CurrentRooms:GetChildren(), function(_, r)
		if r:FindFirstChild("RoomStart") and r.Name~="6" then
